        ...
        <div className="relative">
          ...
          >
            ...
            <div className="group flex items-center gap-2">
              <Link
                href="/contact"
                className="text-brand-primary hover:bg-brand-tertiary inline-flex h-16 items-center rounded-full bg-white px-14 text-[11px] font-medium tracking-wider uppercase transition-all duration-300 hover:shadow-[0_0_30px_-4px_var(--color-brand-tertiary)]"
              >
              ...
              <Link
                ...
                className="text-brand-primary hover:bg-brand-tertiary grid size-16 place-items-center rounded-full bg-white transition-all duration-300"
              >
                <ArrowUpLeft
