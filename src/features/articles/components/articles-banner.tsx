        ...
        <div className="relative mx-auto max-w-4xl">
          ...
          >
            ...
            <div className="group mt-6 flex items-center justify-end gap-2">
              <Link
                href="#articles"
                className="text-brand-primary hover:bg-brand-tertiary inline-flex h-12 items-center rounded-full bg-white px-11 text-[11px] font-medium tracking-wider uppercase transition-all duration-300 hover:shadow-[0_0_30px_-4px_var(--color-brand-tertiary)]"
              >
                Future insights
              </Link>
              <Link
